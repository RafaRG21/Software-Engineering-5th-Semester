...
public class frmMatriz extends javax.swing.JFrame {
    ...
    public chatServidor server;
    public String nombre;
    
    public frmMatriz(String name) {
        initComponents();
    ...
    //Metodos
    public void setServidor(chatServidor server) {
        this.server = server;
    }
    public void cliente(ArrayList<chatCliente> cliente) {
        this.clientes = cliente;
    }
    public void fM1(int filM1){
        this.filasM1 = filM1;
        this.txtFilasM1.setText(String.valueOf(filasM1));
    ...
    public void cM1(int columnM1){
        this.columnasM1 = columnM1;
        this.txtColumnasM1.setText(String.valueOf(columnasM1));
    }
    public void fM2(int filM2){
        this.filasM2 = filM2;
        this.txtFilasM2.setText(String.valueOf(filasM2));
    }
    public void cM2(int columnM2){
        this.columnasM2 = columnM2;
        this.txtColumnasM2.setText(String.valueOf(columnasM2));
    }
    
    public void matriz1(String matriz1){
        this.txtMatriz1.setText(matriz1);
    }
     public void matriz2(String matriz2){
        this.txtMatriz2.setText(matriz2);
    }
    public void secuencial(String sec){
        this.txtAResultadoSecuencial.setText(sec);
    }
    public void forkjoin(String fork){
        this.txtAResultadoForkJoin.setText(fork);
    }
    public void executorService(String exec){
        this.txtAResultadoExecutorService.setText(exec);
    }
    public void secTime(String time){
        this.txtfTiempoSecuencial.setText(time);
    }
     public void execTime(String time){
        this.txtfTiempoExecutorService.setText(time);
    }
      public void forkTime(String time){
        this.txtfTiempoForkJoin.setText(time);
    }
    public int[][] llenarMatriz(int[][] matriz, int filas, int columnas) {
    ...
    private void btnGenerarMatriz1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarMatriz1ActionPerformed
        ...
        if (this.txtFilasM1.getText().isEmpty() || this.txtColumnasM1.getText().isEmpty()) {
            ...
            System.err.println("Matriz 1 generada!");
            
            /*while (numClient < clientes.size()) {
                 try {
             
                    clientes.get(numClient++).resultado("Matriz 1 generada!\n");
                } catch (RemoteException ex) {
                    Logger.getLogger(frmMatriz.class.getName()).log(Level.SEVERE, null, ex);
                }
            }//while*/
            try {
                server.mensaje("matriz1",nombre,nombre+" Genero Matriz 1"+"-"+String.valueOf(filasM1)+"-"+String.valueOf(columnasM1));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
        }
    ...
    private void btnGenerarMatriz2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarMatriz2ActionPerformed
        ...
        if (this.txtFilasM2.getText().isEmpty() || this.txtColumnasM2.getText().isEmpty()) {
            ...
            //RMI
            System.err.println("Matriz 2 generada!");
            
            try {
                server.mensaje("matriz2",nombre,nombre+" genero matriz 2"+"-"+String.valueOf(filasM2)+"-"+String.valueOf(columnasM2));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
        }
    ...
    private void btnSecuencialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSecuencialActionPerformed
        ...
        //RMI
        System.err.println("Matrices multiplicadas en secuencial: Timepo de ejecución: "+fin+" ms");
        /*while (numClient < clientes.size()) {
            try {
                clientes.get(numClient++).resultado(String.valueOf("Tiempo de multiplicacion en secuencial:"+fin+" ms"));
            } catch (RemoteException ex) {
                Logger.getLogger(frmMatriz.class.getName()).log(Level.SEVERE, null, ex);
            }
        }*/
        try {
                server.mensaje("sec",nombre, String.valueOf(fin));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
    ...
    private void btnExecutorServiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExecutorServiceActionPerformed
        ...
        //RMI
        System.err.println("Matrices multiplicadas en ExecutorService: Timepo de ejecución: "+tiempo+" ms");
        /*while (numClient < clientes.size()) {
            try {
                clientes.get(numClient++).mensajeCliente(String.valueOf("Tiempo de multiplicacion en ExecutorService:"+tiempo+" ms"));
            } catch (RemoteException ex) {
                Logger.getLogger(frmMatriz.class.getName()).log(Level.SEVERE, null, ex);
            }
        }*/
        try {
                server.mensaje("exec",nombre,String.valueOf(tiempo));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
    ...
    private void btnForkJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnForkJoinActionPerformed
        ...
        //RMI
        System.err.println("Matrices multiplicadas en forkJoin: Tiempo de ejecución: "+time+" ms");
        /*
        while (numClient < clientes.size()) {
            try {
                clientes.get(numClient++).resultado(String.valueOf("Tiempo de multiplicacion en ForkJoin:"+time+" ms"));
            } catch (RemoteException ex) {
                Logger.getLogger(frmMatriz.class.getName()).log(Level.SEVERE, null, ex);
            }
        }*/
        try {
                server.mensaje("fork",nombre,String.valueOf(time));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
    ...
    private void btnImprimirSecuencialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirSecuencialActionPerformed
        ...
        System.err.println("Resultado de la multiplicacion en Secuencial:\n");
        System.out.println(imprimirMatriz(secuencial.getMatrizresul()));
        /*while (numClient < clientes.size()) {
            try {
                clientes.get(numClient++).resultado("Resultado de la multiplicacion en Secuencial:\n"+imprimirMatriz(secuencial.getMatrizresul()));
            } catch (RemoteException ex) {
                Logger.getLogger(frmMatriz.class.getName()).log(Level.SEVERE, null, ex);
            }
        }*/
        try {
                server.mensaje("secImprimir",nombre,imprimirMatriz(secuencial.getMatrizresul()));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
    ...
    private void btnImprimirExecutorServiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirExecutorServiceActionPerformed
        ...
        //RMI
        System.err.println("Resultado de la multiplicacion en ExecutorService:\n");
        System.out.println(imprimirMatriz(MatrizExecutorService.getRes()));
         /*while (numClient < clientes.size()) {
            try {
                clientes.get(numClient++).resultado("exe"+"-"+imprimirMatriz(MatrizExecutorService.getRes()));
            } catch (RemoteException ex) {
                Logger.getLogger(frmMatriz.class.getName()).log(Level.SEVERE, null, ex);
            }
        }*/
         try {
                server.mensaje("execimprimir",nombre,imprimirMatriz(MatrizExecutorService.getRes()));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
    ...
    private void btnImprimirForkJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirForkJoinActionPerformed
        ...
        if (matriz1 == null || matriz2 == null)
            ...
            this.txtAResultadoForkJoin.setText(imprimirMatriz(MatrizExecutorService.getRes()));
        //RMI
        System.err.println("Resultado de la multiplicacion en forkJoin:\n");
        System.out.println(imprimirMatriz(MatrizExecutorService.getRes()));
         /*while (numClient < clientes.size()) {
            try {
                clientes.get(numClient++).resultado("Resultado de la multiplicacion en ForkJoin:\n"+imprimirMatriz(MatrizExecutorService.getRes()));
            } catch (RemoteException ex) {
                Logger.getLogger(frmMatriz.class.getName()).log(Level.SEVERE, null, ex);
            }
        }*/
         try {
                server.mensaje("forkimprimir",nombre,imprimirMatriz(MatrizExecutorService.getRes()));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
    ...
    private void btnImprimirMatriz01ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirMatriz01ActionPerformed
        ...
        //RMI
        System.err.println("Matriz 1:\n");
        System.out.println(imprimirMatriz(matriz1));
         /*while (numClient < clientes.size()) {
            try {
                clientes.get(numClient++).resultado("Matriz uno:\n\n"+imprimirMatriz(matriz1));
            } catch (RemoteException ex) {
                Logger.getLogger(frmMatriz.class.getName()).log(Level.SEVERE, null, ex);
            }
        }*/
         try {
                server.mensaje("matriz1imprimir",nombre,imprimirMatriz(matriz1));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
    ...
    private void btnImprimirMatriz02ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirMatriz02ActionPerformed
        ...
        //RMI        
        System.err.println("Matriz dos:\n ");
        System.out.println(imprimirMatriz(matriz2));

         /*while (numClient < clientes.size()) {
            try {
                clientes.get(numClient++).resultado("Matriz dos:\n\n"+imprimirMatriz(matriz2));
            } catch (RemoteException ex) {
                Logger.getLogger(frmMatriz.class.getName()).log(Level.SEVERE, null, ex);
            }
        }*/
         try {
                server.mensaje("matriz2imprimir",nombre,imprimirMatriz(matriz2));
            } catch (RemoteException ex) {
                ex.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmMatriz("Server").setVisible(true);
            }
        });
    }
