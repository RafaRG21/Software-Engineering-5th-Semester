...
public class MiniPaint extends JFrame implements ActionListener, MouseListener, MouseMotionListener {
    ...
    public MiniPaint(){
        ...
        //Opción Salir
        JMenuItem opcionSalir = new JMenuItem();
        ...
        opcionLineas.setActionCommand("Líneas");
    ...
    public void actionPerfomed(ActionEvent e){
        ...
        if(comando.equals("Nuevo")){
            ...
            if(comando.equals("Salir")){
                if(JOptionPane.showConfirmDialog(this,"¿En verdad deseas salir?","Confirmación",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
                    dispose();
                    System.exit(0);
                }
            } else
    ...
    public void mouseDragged(MouseEvent e){
        ...
        switch (modo) {
            ...
            case CIRCULOS -> {
                g.drawImage(buffer, 0, 0, area);
                g.drawOval(x, y, getX() - x, e.getY() - y);
                area.getGraphics().drawImage(temporal, 0, 0, this);
            }
        }
    }
